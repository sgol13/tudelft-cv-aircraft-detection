...
abstract class $DeviceOrientationCopyWith<$Res> {
  ...
  @useResult
  $Res call({double x, double y, double z, double w, DateTime timestamp});
}
...
class _$DeviceOrientationImpl extends _DeviceOrientation {
  ...
  @override
  String toString() {
    return 'DeviceOrientation(x: $x, y: $y, z: $z, w: $w, timestamp: $timestamp)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, x, y, z, w, timestamp);
